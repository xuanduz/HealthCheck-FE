        ...
        <ul className="ml-14 flex flex-col gap-10 justify-center">
          <li className="flex gap-10">
            ...
            <div>
              ...
              <p>
                Dịch vụ xét nghiệm Health Check uy tín nhất với nhiều năm kinh
                nghiệm, đội ngũ bác sĩ chuyên gia hàng đầu, hệ thống xét nghiệm
          ...
          <li className="flex gap-10">
            ...
            <div>
              ...
              <p>
                Khách hàng là trên hết, thái độ ân cần, chu đáo, giải đáp thắc
                mắc 24/7.
              </p>
            </div>
          </li>
          ...
          <li className="flex gap-10">
            ...
            <div>
              ...
              <p>
                Thông tin bảo mật tuyệt đối và được cập nhật vào hồ sơ bệnh án
                của bệnh nhân.
              </p>
            </div>
          </li>
